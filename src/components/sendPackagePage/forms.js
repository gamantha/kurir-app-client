            ...
            return (
                <View>
                    ...
                    <Picker
                        ...
                        onValueChange={pickupAddress =>
                            this.onChangeKurirAddress(pickupAddress)
                        }
                    >
                        <Item
                            label="Kurir.id office Bandung"
                            value="Jalan Sukahaji"
                        />
                        <Item
                            label="Kurir.id office Jakarta"
                            value="Jalan Simatupang"
                        />
                    </Picker>
                </View>
            );
            ...
            >
                ...
                <View style={styles.pageFour}>
                    <Form>
                        ...
                        <Picker
                            ...
                            placeholder="Pick one"
                            selectedValue={
                                this.state.item.isCustomPickupAddress
                            }
                            onValueChange={isCustomPickupAddress =>
                                this.onChangeRetrievalMethod(
                ...
                <View style={styles.pageFive}>
                    <Form>
                        ...
                        <Text>
                            {`From ${this.state.sender.senderCity} to ${
                                this.state.receiver.receiverCity
                            }`}
                        </Text>
                        <Text>{`item: ${this.state.item.itemName}`}</Text>
                        <Text>{`luggage: ${this.state.item.itemWeight}`}</Text>
                        <Text>{`item value: ${
                            this.state.item.itemValue
                        }`}</Text>
                        <Text>{`item price: ${
                            this.state.item.itemPrice
                        }`}</Text>
                        <Text>{`retrieval method: ${
                            this.state.pickup.pickupNote
                        }`}</Text>
                        <Button
                            rounded
                            primary
                            onPress={() => this.onSubmitSendPackageForm()}
                        >
                            <Text>Done!</Text>
                        </Button>
                    </Form>
